...
const DrawerFormation = ({ color }: IProps) => {
  return (
    <div>
      <svg width="33" height="26" viewBox="0 0 20 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.8794 6.644V5.6H7.95141V14H9.15141V10.604H13.3634V9.572H9.15141V6.644H13.8794Z" fill={color} />
        <path
...
export default DrawerFormation;
